...
public class LinkedListTest {
    ...
    @Test
    public void given3NumberWhenInsertingSecondInBetweenShouldPassedLInked() {
        MyNode<Integer> myFirstNode = new MyNode<>(56);
        MyNode<Integer> mySecondNode = new MyNode<>(30);
        MyNode<Integer> myThirdNode = new MyNode<>(70);
    ...
    @Test
    public void givenFirstElementWhenDeletedShouldPassedLinkedListResult() {
        MyNode<Integer> myFirstNode = new MyNode<>(56);
        MyNode<Integer> mySecondNode = new MyNode<>(30);
        MyNode<Integer> myThirdNode = new MyNode<>(70);
    ...
    @Test
    public void givenElement_WhenSearch_ShouldPassedLinkedListResult() {
        MyNode<Integer> myFirstNode = new MyNode<>(56);
        MyNode<Integer> mySecondNode = new MyNode<>(30);
        MyNode<Integer> myThirdNode = new MyNode<>(70);
        ...
        boolean result = myLinkedList.searchByElement(30);
        Assert.assertTrue(result);
    }
}